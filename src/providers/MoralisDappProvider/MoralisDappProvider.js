...
function MoralisDappProvider({ children }) {
  ...
  const [contractAddress, setContractAddress] = useState("0x6c6Ae1d2eADa359c8fC8308707DeBa552f35F5C2");
  ...
  return <MoralisDappContext.Provider value={{ walletAddress, chainId, contractABI, contractAddress, selectedCategory, setSelectedCategory}}>{children}</MoralisDappContext.Provider>;
}
